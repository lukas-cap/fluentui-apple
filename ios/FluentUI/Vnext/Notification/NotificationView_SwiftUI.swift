        ...
        if !shouldPresentItself {
            ...
            GeometryReader { proxy in
                ...
                let calculatedNotificationWidth: CGFloat = {
                    ...
                    return isFullLength ? proposedWidth / 2 : proposedWidth - (2 * tokens.presentationOffset)
                }()
                ...
                notification
                    ...
                    .frame(width: proposedSize.width, height: proposedSize.height, alignment: .bottom)
            }
        }
    }
